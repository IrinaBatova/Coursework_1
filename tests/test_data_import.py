...
mock_file = mock_open(read_data='{"user_currencies": ["USD", "EUR", "CNY"],'
...
def test_read_json_file_() -> None:
    with patch("json.load", return_value={"user_currencies": ["USD", "EUR", "CNY"], "user_stocks": ["AAPL", "AMZN", "GOOGL", "MSFT", "TSLA"]}):
        assert read_json_file("./data/operations.json") == {"user_currencies": ["USD", "EUR", "CNY"],
                                                            "user_stocks": ["AAPL", "AMZN", "GOOGL", "MSFT", "TSLA"]}
