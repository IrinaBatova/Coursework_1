...
def test_main_page(
    mock_get_stock_prices, mock_get_currency_rates, mock_get_top_transactions, mock_get_data_card, mock_get_greeting
):
    ...
    mock_get_data_card.return_value = [
        {"last_digits": "5814", "total_spent": 1262.00, "cashback": 12.62},
        {"last_digits": "7512", "total_spent": 7.94, "cashback": 0.08},
    ]
    ...
    assert main_page("2018-01-01 07:57:29") == {
        "cards": [
            {"cashback": 12.62, "last_digits": "5814", "total_spent": 1262.0},
